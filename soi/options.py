...
[default=%(default)s]")
	...
	parser.add_argument('-inparalog', action='store_true', default=True,
						dest='inparalog',
						help=argparse.SUPPRESS) #'Include paralogs (same-species gene pairs) in -s input [default: excluded]')
